...
<h1 class="ui center aligned icon dividing header">
    ...
    <div class="content">
      Detail Reservasi untuk Tutorial Mata Kuliah
    </div>
</h1>
<br>
        ...
        <div visible>
          <div id="form1" >
            ...
            <div class="sixteen wide field">
              ...
              <input type="text" name="nohp" placeholder="Nomor HP" value="{{$reservation->matkul->name}}" readonly="">
            </div>
            <div class="sixteen wide field">
              <label>Materi</label>
              <textarea type="text" name="materi" placeholder="Materi" style="resize:vertical;height:50%" readonly=""><?php echo ($reservation->materi)?></textarea>
            </div>
            <div class="sixteen wide field">
              <label>Jumlah Mahasiswa</label>
              <input type="text" name="jumlah" placeholder="Jumlah Mahasiswa" value="{{$reservation->jumlah}}" readonly="">
            </div>
  ...
  <div  class="seven wide column">
    <div class="ui red segment" style="padding-bottom:10%">
      ...
      <form class="ui form" action="" method="post">
        ...
        <div class="sixteen wide field">
          <label>Penutor (non-admin)</label>
          <input type="text" name="penutor_lain" value="{{$reservation->penutor}}">
        </div>
        <div class="sixteen wide field">
