...
<br>
<div style="padding:3%;padding-top:0px;">
  <div class="ui grid stackable" style="margin-bottom:5%">
    <div class="nine wide column">
      <div class="ui teal segment" style="">
        <div class="ui three top attached steps">
          ...
          <a class="disabled step" id="matkul">
            ...
            <div class="content">
              ...
              <div class="description">Masukkan mata kuliah dan materi yang ingin diajarkan</div>
            </div>
          </a>
        ...
        <div class="ui attached segment">
          <form class="ui form" id="form_reservasi" action="{{url('user/pesan')}}" method="post">
            <div visible>
              <div id="form1" >
            ...
            <div hidden>
              <div id="form2" >
                ...
                <div class="sixteen wide field">
                  ...
                  <select name="mataKuliah" id="matakuliah" class="ui search dropdown">
                ...
                <div class="sixteen wide field">
                  <label>Materi (boleh lebih dari 1)</label>
                  <textarea type="text" name="materi" id="materi" placeholder="Materi" style="resize:vertical;height:50%"></textarea>
                </div>
                <div class="sixteen wide field">
                  <label>Jumlah Mahasiswa</label>
                  <input type="text" name="jumlah" id="jumlah" placeholder="Jumlah Mahasiswa">
                </div>
              ...
              <div id="form3" >
                <div ng-app="testApp" ng-strict-di>
                  <div class="sixteen wide field" ng-controller="mainController">
                    <label>Tanggal</label>
                    <input type="text" name="tanggal" id="tanggal" ng-flat-datepicker datepicker-config="datepickerConfig" ng-model="date" ui-date ui-date-format>
                  </div>
                </div>
                <br>
                <div class="sixteen wide field bootstrap-timepicker timepicker">
                  <label>Jam Mulai</label>
                  <input type="text" data-field="time" readonly name="jam_mulai" id="jam_mulai">
                  <div id="dtBox1"></div>
                </div>
                <div class="sixteen wide field bootstrap-timepicker timepicker">
                  <label>Jam Akhir</label>
                  <input type="text" data-field="time" readonly name="jam_akhir" id="jam_akhir">
                  <div id="dtBox2"></div>
                </div>
