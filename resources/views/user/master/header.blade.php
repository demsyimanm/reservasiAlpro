  <link rel="stylesheet" type="text/css" href="{{URL::to('assets/bootstrap/css/bootstrap.css')}}">
  <link rel="stylesheet" type="text/css" href="{{URL::to('assets/Semantic/dist/semantic.min.css')}}">  
  ...
  <link rel="stylesheet" type="text/css" href="{{URL::to('assets/Semantic/components/reveal.css')}}">
